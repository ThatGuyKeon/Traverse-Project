...
The goal of this level is to create a calm exploration experience with moments of intensity through environmental puzzles and traversal challenges. The player explores a mountain terrain while managing visibility in very dark areas and using environmental clues to progress.
...
Exploration is rewarded. Players who look to the left and right of the main path may discover a hidden secret area that is required to fully complete the level. This encourages curiosity and environmental awareness rather than strictly linear movement.
...
The game can also be paused and restarted if needed.

Players should also check both sides of the path because there is a hidden area required to fully finish the level.
